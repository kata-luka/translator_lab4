import pathlib
import re
from postfixExpr_interpreter.correction import correction
...
tableOfLanguageTokens = \
    {'program': 'keyword', 'end': 'keyword', \
     'if': 'keyword', 'while': 'keyword', 'for': 'keyword','then': 'keyword', 'else': 'keyword', 'do': 'keyword', 'by': 'keyword', 'fi': 'keyword', \
     'print': 'keyword', 'input': 'keyword', \
     '=': 'assign_op', '.': 'dot', ',': 'punct', ' ': 'ws', '\t': 'ws', '\n': 'nl', '-': 'add_op', \
     '+': 'add_op', '*': 'mult_op', '/': 'mult_op', '(': 'brackets_op', ')': 'brackets_op', '{': 'brackets_op',
     '}': 'brackets_op', \
     'is': 'rel_op', '<=': 'rel_op', '!=': 'rel_op', '>=': 'rel_op', '<': 'rel_op', '>': 'rel_op', '^': 'pow_op'}
